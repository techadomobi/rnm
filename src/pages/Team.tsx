    ...
    <div className="min-h-screen">
      ...
      <section className="relative section-padding gradient-soft overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-slate-900">Our Team</h1>
            ...
            {leadership.map((member, index) => (
              ...
              >
                ...
                <div className="flex justify-center space-x-3">
                  <a
                    href="#"
                    className="group/icon w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-colors"
                  >
                    <Linkedin className="w-5 h-5 text-blue-600 group-hover/icon:text-white" />
                  </a>
                  <a
                    href="#"
                    className="group/icon w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-colors"
                  >
                    <Twitter className="w-5 h-5 text-blue-600 group-hover/icon:text-white" />
                  </a>
                  <a
                    href={`mailto:${member.email}`}
                    className="group/icon w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-colors"
                  >
                    <Mail className="w-5 h-5 text-blue-600 group-hover/icon:text-white" />
                  </a>
                </div>
              </motion.div>
            ))}
